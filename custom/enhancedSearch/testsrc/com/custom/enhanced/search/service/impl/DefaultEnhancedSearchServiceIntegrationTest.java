...
import com.custom.enhanced.search.service.impl.DefaultEnhancedSearchService;
 ...
 */
@IntegrationTest
public class DefaultEnhancedSearchServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "enhancedSearchPlatformLogo";

		// when
		final String logoUrl = enhancedSearchService.getHybrisLogoUrl(logoCode);
