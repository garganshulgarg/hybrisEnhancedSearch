...
public class DefaultEnhancedSearchService implements EnhancedSearchService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultEnhancedSearchService.class);
	...
	{
		return DefaultEnhancedSearchService.class.getResourceAsStream("/enhancedSearch/sap-hybris-platform.png");
	}
