...
/**
 * This is the extension manager of the EnhancedSearch extension.
 */
public class EnhancedSearchManager extends GeneratedEnhancedSearchManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(EnhancedSearchManager.class);
	 ...
	 */
	public static EnhancedSearchManager getInstance()
	{
		return (EnhancedSearchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(EnhancedSearchConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EnhancedSearchManager() // NOPMD 
	{
		LOG.debug("constructor of EnhancedSearchManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of EnhancedSearchManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of EnhancedSearchManager called, current tenant: {}", getTenant().getTenantID());
	}
