 ...
 */
package com.custom.enhanced.search.controller;
...
@Controller
public class EnhancedSearchHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", enhancedSearchService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
