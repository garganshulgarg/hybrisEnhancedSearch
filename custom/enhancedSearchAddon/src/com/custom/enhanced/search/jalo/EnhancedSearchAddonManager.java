...
/**
 * This is the extension manager of the EnhancedSearchAddon extension.
 */
public class EnhancedSearchAddonManager extends GeneratedEnhancedSearchAddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EnhancedSearchAddonManager.class.getName());
	 ...
	 */
	public static EnhancedSearchAddonManager getInstance()
	{
		return (EnhancedSearchAddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EnhancedSearchAddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EnhancedSearchAddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EnhancedSearchAddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EnhancedSearchAddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EnhancedSearchAddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
